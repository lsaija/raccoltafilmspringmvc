				...
				<div class="container">
					...
					<div class='card'>
					    ...
					    <div class='card-body'>
							...
							<form:form modelAttribute="edit_film_attr"  method="post" action="${pageContext.request.contextPath }/film/saveUpdateFilm" novalidate="novalidate" class="row g-3">
								<form:hidden path="id"/>
								...
								<div class="col-md-6">
									<label for="minutiDurata" class="form-label">minutidurata <span class="text-danger">*</span></label>
									<spring:bind path="minutiDurata">
										<input type="text" name="minutiDurata" id="minutiDurata" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire minuti durata" value="${edit_film_attr.minutiDurata }" required>
									</spring:bind>
