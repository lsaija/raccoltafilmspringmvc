			...
			<main class="flex-shrink-0">
			  <div class="container">
			  		...
			  		<div class='card'>
					    ...
					    <div class='card-body'>
					     <form:form modelAttribute="delete_film_attr" method="post" action="${pageContext.request.contextPath}/regista/saveDeleteRegista" class="row g-3" novalidate="novalidate">
					    	<dl class="row">
					    ...
					    <div class='card-footer row' >
					        ...
					        <form action="${pageContext.request.contextPath}/regista/saveDeleteRegista" method="post">
